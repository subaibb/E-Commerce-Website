...
"use client";
import { Blackout } from '../../components/SideNav';
import { FooterLink } from '../../(customer page)/_components/FooterLink';
import { useEffect } from 'react';
import { useShowSuccess } from '../../hooks/Contexts';
  ...
  return (
    ...
    >
      <div className="w-1/2 h-[60%] flex justify-between items-center flex-col">
        <h1 className="w-full xl:text-2xl lg:text-xl sm:text-sm xs:text-xs text-textscondary text-center">Your purchase was successful,you will be redirected to your cart.</h1>
        <FooterLink Style={{
        width: "70%",
        }}  Link="/">Main Page</FooterLink>
      </div>
    </motion.div>
  );
}
