...
export function RatingSection():JSX.Element{
    ...
    return(
        <div className=" md:w-full md:h-[40%] xs:h-full flex flex-col md:justify-start xs:justify-center items-center xs:w-1/2">
            <Stars Style={{
                width:20,
                height:20,
                marginRight:4,
                ...
                <div className="w-full h-1/2 flex flex-col justify-between">
                    ...
                    <ProgressBar percent={63} ReviewCount={4} Count={4}/> 
                    <ProgressBar percent={23} ReviewCount={4} Count={3}/>   
                    <ProgressBar percent={12} ReviewCount={4} Count={2}/> 
                    <ProgressBar percent={80} ReviewCount={4} Count={1}/>  
                </div>
