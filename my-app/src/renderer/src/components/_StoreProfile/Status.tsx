...
export default function Status({label,totals,delay,location,percentage,style}): JSX.Element {
  ...
  let formattedPrice = `${priceString
    ...
    return (
        <motion.div className={`relative w-[20.2vw] h-[17.4vh] ${style} bg-default rounded-[14px] shadow-[2px_4px_4px_#68B6FF0D]`}
