...
export default function CustomerLabel({delay}): JSX.Element {
    return (
        ...
        >
            ...
            <h2 className="w-[6vw] h-[3vh] relative text-[#D9D9D9] flex items-center justify-center mr-auto ml-1">2024/01/03</h2>
            <LabelCounters/>
            </div>
            ...
            <div className=" relative w-[5.72vw] h-[10.1vh] left-[6.1vw] top-[3vh] rounded-full bg-[#F6F8FF] flex justify-center items-center">
                <h2 className=" text-secondary text-5xl">S</h2>
            </div> 
            
            <div className=" relative w-[12.7vw] h-[5vh] top-[3vh] left-[2.6vw] items-center justify-center flex flex-col">
            <label className="p-[1vw] relative text-[17px] text-secondary font-normal ">Salim Abu Khalid</label> 
